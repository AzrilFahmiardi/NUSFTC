"""
English sentiment analyzer — VADER (primary) + TextBlob (cross-validation consensus).

VENDORED verbatim from `../nlp social listening/nlp/sentiment.py`.
Copied (not imported) because the `nlp` package name collides across the two sibling
projects. Used for en-language scraped rows; Chinese rows use sentiment_cn.
"""
